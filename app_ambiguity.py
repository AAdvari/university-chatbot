...
REFORMULATE_SYSTEM = (
    ...
    "اگر کاربر **نخواست به سوال رفع ابهام پاسخ دهد یا نمی‌داند** (مثلاً نمیدانم، مهم نیست، هرکدام)، آن سوال را **نادیده بگیر** و مجددا آن را نپرس. "
    "سوال بازنویسی‌شده را طوری بنویس که همان قصد اولیه را داشته باشد و جایی که کاربر مشخص نکرده با عبارتی مثل «با فرض هر مقطع» یا «بدون مشخص بودن مقطع» بیان شود تا سیستم بتواند پاسخ بدهد.\n\n"
    "سوال جدید باید:\n"
